...
if __name__ == '__main__':
    ...
    summary_template = """
            ...
            3. A topic that may interests them
            4. 2 creative ice breakers to open conversation with them
        """
    
    

    # api_key = 'CEaC3K3yf8Fj8iDs-Wshnw'
    ...
    # with open('output_linkedin.json', 'w') as file:
    ...
    # # Open a file in write mode
    # with open('output_profile.json', 'w') as file:
    #     # Serialize the JSON data and write it to the file
    #     json.dump(response.json(), file)
    ...
    linkedin_profile_url = linkedin_lookup_agent(name="Desh Raj")
    ...
    # print(scrape_user_tweets(username="@Test979948"))
    ...
    # information argument became valid because we used {information} within the prompt and gave that to the chain
    # so when we run, it is expecting information keyword
